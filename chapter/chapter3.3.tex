...
\begin{enumerate}
    ...
    Ví dụ: tại dòng 98 và 99, \texttt{\#20030–\#20037} của \texttt{External Input} được chuyển vào \texttt{\#00030–\#00037} của \texttt{General Purpose Input}.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{figures/Chapter3/plc-cc1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Chapter3/plc-cc2.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Chapter3/plc-cc3.png}
