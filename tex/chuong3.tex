...
Sơ đồ khối hệ thống như Hình \ref{c2:struc}:

\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/Chapter2/structure.png}
...
Khi khởi tạo project cần chọn dòng PLC (Q mode); loại CPU (Q13UDV); loại project (Simple Project) và ngôn ngữ lập trình sử dụng trong project (Ladder). Cấu hình như Hình \ref{c2:newprj}.
\begin{figure} [h]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/Chapter2/newprj.png}
...
\begin{enumerate}
    \item Cấu hình base unit và các module giống với thiết lập phần cứng như Hình \ref{c2:hardware}. 
    Thiết lập thông tin của base unit và vị trí module trong GX Works2 như Hình \ref{c2:io} tại \textit{Parameter} $\rightarrow$ \textit{PLC Parameter} $\rightarrow$ \textit{I/O Assignment}.
    
    \item Cấu hình giao tiếp/kết nối giữa PLC với GX Works2 như Hình \ref{c2:ethernet}. Bao gồm thiết lập IP cho PLC, giao thức MC Protocol.
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figures/Chapter2/phancung.png}
    \caption{Thiết lập phần cứng}
    \label{c2:hardware}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figures/Chapter2/io.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figures/Chapter2/ethernet.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figures/Chapter2/kepwareprj.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figures/Chapter2/kepwarechannel.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figures/Chapter2/kepwaredevice.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figures/Chapter2/baslerip.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figures/Chapter2/baslerauto.png}
