...
Sau khi kết thúc thiết lập, bấm End để lưu thiết lập.
 ...
 các trạm Remote I/O và Remote Device Station, tiếp đến là cấu hình giao tiếp CC-Link tại trạm Master (module QJ16BT11N). 
...
\end{figure}
    ...
    Sau khi đã cấu hình xongtương phản hoặc hiệu chỉnh màu.
