...
Kiểm tra thủ công không còn đáp ứng được yêu cầu về tốc độ và độ chính xác của dây chuyền sản xuất hiện đại. Bên cạnh đó, chi phí đầu tư cho các máy AOI/AVI thương mại cao khiến doanh nghiệp khó chủ động công nghệ. 
...
\begin{itemize}
    ...
    \item Thiết kế, bổ sung mô hình phần cứng.
    \item Thiết kế phần mềm cho hệ thống tự động hóa có sẵn.
    \item Xử lý ảnh.
...
\begin{itemize}
    \item Nghiên cứu lý thuyết: thị giác máy, xử lý ảnh, trích xuất đặc trưng, AI, các thuật toán đối sánh và phân loại lỗi.
    ...
    \item Xây dựng và kiểm chứng mô hình: triển khai thực tế trên fixture hoặc dây chuyền..
\end{itemize}
